          ...
          <div className="fixed inset-0 z-[100] p-3 sm:p-5">
            ...
            >
                ...
                <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                  <div>
                    ...
                    <p className="mt-3 max-w-2xl text-[#7b6758] text-[1rem] leading-7 dark:text-[#b4a093]">
                      文档内容已经重新排版成更大的阅读面板，主栏更宽，留白更稳，浏览时不会再显得缩在正中间。
                    </p>
                  </div>
              ...
              <div className="flex-1 overflow-y-auto bg-[linear-gradient(180deg,rgba(251,247,242,0.88),rgba(247,240,231,0.72))] px-4 py-4 sm:px-6 sm:py-6 dark:bg-[linear-gradient(180deg,rgba(21,18,16,0.88),rgba(17,14,13,0.72))]">
                <div className="mx-auto w-full max-w-[920px] rounded-[30px] border border-[#eee2d6] bg-white/92 px-5 py-6 shadow-[0_24px_70px_-50px_rgba(55,37,23,0.26)] sm:px-8 sm:py-8 dark:border-[#342923] dark:bg-[rgba(28,23,20,0.88)] [&_img]:my-6 [&_img]:block [&_img]:h-auto [&_img]:w-full [&_img]:rounded-[24px] [&_img]:border [&_img]:border-[#eadfd6] [&_img]:bg-transparent [&_img]:shadow-[0_16px_40px_rgba(78,54,37,0.1)] dark:[&_img]:border-[#3c2f28] dark:[&_img]:shadow-none">
